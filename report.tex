...
\begin{tabular}{c}
\\[0.005cm]
\Large{SF2521 : Numerical Solutions of Differential Equations }\\[0.3cm] %THIS IS THE TITLE
Homework 1\\[0.3cm]
...
\lstinputlisting{eulerImpl.m}
\lstinputlisting{conv.m}
\lstinputlisting{conserv.m}
\lstinputlisting{plots4_1.m}
\lstinputlisting{variableCoeff.m}
\lstinputlisting{varCoeffConv.m}
\lstinputlisting{bound.m}
\lstinputlisting{boundConv.m}
\end{document}
